...
export default class UserManagement extends React.Component {
  ...
  renderNewUserModal() {
    ...
    return (
      ...
      >
        <Modal.Header closeButton>
          <Modal.Title>新用户</Modal.Title>
        </Modal.Header>
        <Modal.Body>
          <Tabs id="createUserTabs">
            <Tab eventKey="singleUser" title="用户信息">
              <Form horizontal>
            ...
            <Tab eventKey="multiUser" title="从文件中批量处理用户">
              <Form>
                <FormGroup>
                  <ControlLabel>请像下表一样格式化用户文件.</ControlLabel>
                ...
                <FormGroup id="userFileDragAndDrop">
                  ...
                  >
                    <span>将CSV用户文件拖到此处或单击上传. 接受以下列分隔符: &apos;,&apos; or &apos;;&apos; or &apos;tab&apos;.
                    </span>
                  </CSVReader>
                </FormGroup>
                <FormGroup>
                ...
                <FormGroup>
                  <ControlLabel>处理摘要</ControlLabel>
                  <FormControl
                    readOnly
          ...
          <Modal.Footer>
            ...
            <Button bsStyle="warning" onClick={() => this.handleNewUserClose()} >取消</Button>
          </Modal.Footer>
        </Modal.Body>
      </Modal>
    );
