...
import SmiSelect from 'src/apps/chemscanner/components/SmiSelect';
import HelpPopover from 'src/apps/chemscanner/components/HelpPopover';
  ...
  render() {
    ...
    return (
      <div className="chemscanner-menu">
        ...
        <ButtonGroup>
          <DropdownButton title="导出" id="chemscanner-export-dd">
