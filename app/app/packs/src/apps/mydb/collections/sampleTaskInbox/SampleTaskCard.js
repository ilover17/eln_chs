  ...
  const droppedSample = () => {
    ...
    return (
      <div>
        ...
        <button className="btn btn-danger" type="button" onClick={removeSample}>清除样本</button>
        <button className="btn btn-success pull-right" type="button" onClick={saveSampleTask}>保存到样本</button>
      </div>
    );
  };
