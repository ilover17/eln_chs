...
export default class ReportContainer extends Component {
  ...
  panelHeader() {
    ...
    return <PanelHeader title="报告生成" btns={btns} />;
  }
    ...
    return (
      ...
      >
        ...
        <Tabs
          ...
          style={{padding:"15px"}}
        >
          <Tab eventKey={0} title="配置" style={tabStyle}>
            <Config
              imgFormat={imgFormat}
              fileName={fileName}
          ...
          <Tab eventKey={1} title="设置" style={tabStyle}>
            <Setting
              template={template}
          ...
          <Tab eventKey={4} title="预览" style={tabStyle}>
            <div className="panel-fit-screen">
              <Previews
