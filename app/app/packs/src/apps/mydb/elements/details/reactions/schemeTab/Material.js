...
const refreshSvgTooltip = <Tooltip id="refresh_svg_tooltip">刷新反应图</Tooltip>;

const AddtoDescToolTip = <Tooltip id="tp-spl-code" className="left_tooltip">添加到描述或附加信息中以获取发布和纯化详细信息</Tooltip>;
