  ...
  stereoAbsInput() {
    ...
    return (
      <FormGroup style={{ width: '50%', paddingRight: '10px' }}>
        <ControlLabel>立体Abs</ControlLabel>
        <Select
          name="stereoAbs"
          clearable={false}
  ...
  stereoRelInput() {
    ...
    return (
      <FormGroup style={{ width: '50%' }}>
        <ControlLabel>立体Rel</ControlLabel>
        <Select
          name="stereoRel"
          clearable={false}
          disabled={!sample.can_update}
                    ...
                    <td style={{ width: '47%' }}>
                      <div className="name-form" style={{ marginBottom: '15px' }}>
                        ...
                        <div style={{ width: '40%', paddingLeft: '5px' }}>
                          {
                            this.numInputWithoutTable(sample, 'purity', 'n', ['n'], 5, '纯度/浓度', '', isDisabled)
                          }
                        </div>
                      </div>
                    </td>
