    ...
    return (
      <div className={['create', 'update'].includes(this.state.status) ? 'container-fluid' : 'container'}>
          ...
          <nav aria-label="breadcrumb">
            {this.state.status == 'list' &&
              <ol className="breadcrumb">
                <li className="breadcrumb-item active" aria-current="page">Chemotion文件转换管理</li>
              </ol>
            }
            {['upload', 'create'].includes(this.state.status) &&
              <ol className="breadcrumb">
                <li className="breadcrumb-item" aria-current="page"><a href="">Chemotion文件转换管理</a></li>
        ...
        <Modal show={this.state.createdModal}>
          <Modal.Header>
            <Modal.Title>已成功创建配置!</Modal.Title>
          </Modal.Header>
        ...
        <Modal show={this.state.deleteModal}>
          <Modal.Header>
            <Modal.Title>是否确实要删除此配置?</Modal.Title>
          </Modal.Header>
          <Modal.Footer>
            <Button bsStyle="default" onClick={this.hideDeleteModal}>取消</Button>
            <Button bsStyle="danger" onClick={this.deleteProfile}>删除配置</Button>
          </Modal.Footer>
        </Modal>
      </div>
    )
