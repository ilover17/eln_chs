      ...
      return (
        <td>
          ...
          <span className={'collapse' + (showRowAdd ? 'in' : '')}>
            ...
            />
            <Button bsSize="xsmall" type="button" bsStyle="warning" onClick={() => this.addUser(group)}>保存到组</Button>
          </span>
        </td>
      );
    }
