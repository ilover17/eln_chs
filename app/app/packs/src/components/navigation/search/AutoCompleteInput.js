...
export default class AutoCompleteInput extends React.Component {
  ...
  renderSuggestions() {
    ...
    let types = {
      sample_name : {icon: 'icon-sample', label: '样本名称'},
      sample_short_label : {icon: 'icon-sample', label: '样本短标签'},
      sample_external_label : {icon: 'icon-sample', label: '样本外部标签'},
      polymer_type : {icon: 'icon-polymer', label: 'Polymer'},
      reaction_name : {icon: 'icon-reaction', label: '反应名称'},
      reaction_status : {icon: 'icon-reaction', label: '反应状态'},
      reaction_short_label : {icon: 'icon-reaction', label: '反应 label'},
      reaction_rinchi_string: { icon: 'icon-reaction', label: '反应 RInChI' },
      wellplate_name : {icon: 'icon-wellplate', label: '孔盘'},
      ...
      conditions : {icon: 'icon-screen', label: '条件'},
      element_short_label: {icon: 'icon-element', label: '元素短标签'}
    }
    if(suggestions) {
      return (
        <div>
