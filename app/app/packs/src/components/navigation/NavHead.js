...
const NavHead = () => {
  ...
  return(
    <Navbar.Brand>
      <NavDropdown title='化合物' className="navig-brand" id="bg-nested-dropdown-brand">
        <MenuItem eventKey="11" href="http://www.chemotion.net" target="_blank">化合物库</MenuItem>
        ...
        <MenuItem divider />
        <MenuItem eventKey='15' href={isHome ? '/' : '/home'} target="_self">{isHome ? 'ELN首页' : 'ELN首页'}</MenuItem>
        <MenuItem divider />
