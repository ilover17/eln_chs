...
const SamOption = (props) => {
  ...
  return (
    <div className="generic_sam_options">
      <OverlayTrigger delayShow={1000} placement="right" overlay={<Tooltip id={uuid.v4()}>与此样本关联</Tooltip>}>
        <Radio
          name={`dropS_${rUUID}`}
      ...
      <OverlayTrigger delayShow={1000} placement="right" overlay={<Tooltip id={uuid.v4()}>分离样本并关联</Tooltip>}>
        <Radio
          name={`dropS_${rUUID}`}
