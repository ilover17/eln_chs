...
export default class ModalExportCollection extends React.Component {
  ...
  renderButtonBar() {
    ...
    const bTitle = processing === true ? '导出中' : '导出ZIP';
    return (
      <ButtonToolbar>
        <div className="pull-right">
          <ButtonToolbar>
            ...
            <Button
              ...
              title="导出成压缩ZIP文件(incl. attachments)"
  ...
  render() {
    ...
    return (
      <div className="export-collections-modal">
        {this.renderCollections('全局集合', 'lockedRoots')}
        {this.renderCollections('我的集合', 'unsharedRoots')}
        {this.renderSharedCollections('我分享的集合', 'sharedRoots')}
        {this.renderSharedCollections('分享给我的集合', 'remoteRoots')}
        {this.renderCheckAll()}
