    ...
    return (
      <div>
        ...
        >
          ...
          {itemTables}
          <MenuItem divider />
          <MenuItem onSelect={() => this.createWellplateFromSamples()}>从样本创建孔盘</MenuItem>
          <MenuItem onSelect={() => this.createScreenFromWellplates()}>从孔盘创建屏幕</MenuItem>
          <MenuItem divider />
          <MenuItem onSelect={() => this.copySample()} disabled={this.isCopySampleDisabled()}>复制样本</MenuItem>
          <MenuItem onSelect={() => this.copyReaction()} disabled={this.isCopyReactionDisabled()}>复制反应</MenuItem>
