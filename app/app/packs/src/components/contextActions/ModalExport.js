    ...
    this.state = {
      columns: {
        sample: [
          ...
          { value: "external_label", text: "外部标签", checked: true },
          { value: "short_label", text: "短标签", checked: false },
          ...
          { value: "is_top_secret", text: "是否绝密?", checked: false },
        ...
        reaction: [
          ...
          { value: "short_label", text: "r 短标签", checked: true },
